...
import { Button, Form, FormGroup, Label, Input, Col, Breadcrumb, BreadcrumbItem } from 'reactstrap';
...
class Contact extends Component {
   constructor(props){
       ...
       //bind each handler to the constructor each time
   ...
   handleSubmit(event){
       ...
       alert("Connected"); //delete later just make sure it works
